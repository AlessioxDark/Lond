...
const ImgStory = ({ content, onClose, isOpen, forward }: imgStoryProps) => {
	...
	return (
		<div className="h-full w-full relative rounded-2xl overflow-hidden bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl border border-white/10 shadow-2xl">
